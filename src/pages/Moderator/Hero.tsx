  ...
  return (
    ...
    >
      ...
      >
        ...
        <CustomText
          text={
            "As a moderator at Presidy, you get to enjoy the best of both worlds: a FREE subscription plan and the ability to save money by managing shared subscription plans. It's a win-win situation!"
          }
          style={{
        ...
        >
          <Link
            to={isModerator ? `/moderator-dashboard` : "#moderator-register"}
          >
            <CustomButton
              text={"Get Started"}
              sx={{
